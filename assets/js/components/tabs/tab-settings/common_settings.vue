            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" class="option" v-model="elAllowToCreateOrdersWithoutPayment" name="allow_to_create_orders_without_payment">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>                        </td>
                        <td>
                            <input type="checkbox" class="option" v-model="elGoogleMapAPIHideRoutes" name="google_map_api_hide_routes"> {{ googleMapAPIHideRoutesLabel }}
                        </td>
                    </tr>
                    <tr>
                        <td>
