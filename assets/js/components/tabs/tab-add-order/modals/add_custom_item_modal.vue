            ...
            <b-form @submit.stop.prevent="submit">
                <div>
                    <label class="col-12 col-md-4">{{ lineItemNameLabel }}
                        <b-form-input type="text" name="name" v-model.trim="name" ref="name" required v-if="typeFieldName.type === 'input'"></b-form-input>
                        <b-form-textarea name="name" v-model.trim="name" ref="name" required v-if="typeFieldName.type === 'textarea'" :rows="typeFieldName.meta ? typeFieldName.meta.rows : ''" :cols="typeFieldName.meta ? typeFieldName.meta.cols : ''"></b-form-textarea>
                    </label>
