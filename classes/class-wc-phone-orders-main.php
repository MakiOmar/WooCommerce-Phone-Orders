...
/**
	...
	public static function load_scripts() {
	    ...
	    $script_rel_path = 'assets/js/build-app.js';
	    $script_url = plugin_dir_url( __DIR__ ) . $script_rel_path;
	    $script_path = plugin_dir_path( __DIR__ ) . $script_rel_path;
	    $script_ver = WC_PHONE_ORDERS_VERSION . '-' . time();
